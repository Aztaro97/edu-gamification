...
export default function DailyPage() {
  ...
  const choices =
    q?.type === "mcq"
      ? isAr && q.choicesAr
        ...
        : q.choices ?? []
      : [
          isAr ? t("trueLabel") : "TRUE",
          isAr ? t("falseLabel") : "FALSE",
        ];
  ...
  return (
    <div className="max-w-3xl mx-auto pt-4">
      <div className="mb-5">
        <div
          className="text-[10px] tracking-[0.35em] uppercase text-[#C8A951]"
      ...
      >
        ...
        {stage === "intro" && (
          <div className="relative p-8 text-center">
            ...
            <div className="flex justify-center gap-3 mt-6">
              ...
              >
                <div className="text-[9px] tracking-widest uppercase text-[#C8A951]">
                  {t("endsIn")}
                </div>
            ...
            <div className="mt-6 flex justify-center gap-3">
              ...
              >
                {dailyCompleted ? t("completed") : t("begin")}
              </GoldButton>
            </div>
          </div>
        )}
              ...
              <div className="flex items-center gap-2">
                ...
                <div
                  ...
                  style={{
                    ...
                    animation:
                      timer < 10 ? "pulse 0.5s ease-in-out infinite" : "none",
                  }}
                >
                  {timer}s
                </div>
            ...
            >
              <div
                style={{
                  ...
                  background:
                    timer < 15
                      ? "linear-gradient(90deg, #EF3340, #FF5E6B)"
        ...
        {stage === "done" && (
          <div className="relative p-8 text-center">
            ...
            <div className="font-display text-[11px] tracking-[0.4em] uppercase text-[#F4D97A]">
              {t("completeTitle")}
            </div>
            ...
            <div className="mt-6 flex justify-center">
              <GoldButton onClick={() => router.push("/")}>
                {t("backToJourney")}
              </GoldButton>
            </div>
          </div>
